...
@Localized("reporting.ContactGenderCohortDefinition")
public class ContactGenderCohortDefinition extends BaseCohortDefinition {
	 ...
	 * Default constructor
	 */
	public ContactGenderCohortDefinition() {
		super();
	}
