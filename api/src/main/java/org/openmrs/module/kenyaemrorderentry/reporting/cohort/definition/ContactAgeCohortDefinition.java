...
@Localized("reporting.ContactAgeCohortDefinition")
public class ContactAgeCohortDefinition extends BaseCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public ContactAgeCohortDefinition() {
		super();
	}

	public ContactAgeCohortDefinition(Integer minAge, Integer maxAge, Date effectiveDate) {
		super();
		this.minAge = minAge;
		this.maxAge = maxAge;
