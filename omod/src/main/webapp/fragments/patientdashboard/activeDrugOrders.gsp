...
<div class="info-section">
    <div class="info-header">
        ...
        <h3>${ ui.message("kenyaemrorderentry.patientdashboard.activeDrugOrders").toUpperCase() }</h3>
        <% if (context.hasPrivilege("App: kenyaemrorderentry.drugOrders")) { %>
            <a href="${ ui.pageLink("kenyaemrorderentry", "drugOrders", [patient: patient.id, returnUrl: ui.thisUrl()]) }">
