...
public class ManifestOrdersMissingSamplesHomePageController {

    public void get(@RequestParam(value = "manifest", required = false) LabManifest manifest, @SpringBean KenyaUiUtils kenyaUi,
                    UiUtils ui, PageModel model) {

        List<LabManifestOrder> allOrders = Context.getService(KenyaemrOrdersService.class).getLabManifestOrderByStatus("Record not found");
